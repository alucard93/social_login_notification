...
mixin _$LoginStore on _LoginStoreBase, Store {
  late final _$isFacebookLoadingAtom = Atom(
    name: '_LoginStoreBase.isFacebookLoading',
    context: context,
  );
  ...
  late final _$isGoogleLoadingAtom = Atom(
    name: '_LoginStoreBase.isGoogleLoading',
    context: context,
  );
  ...
  late final _$signInWithGoogleAsyncAction = AsyncAction(
    '_LoginStoreBase.signInWithGoogle',
    context: context,
  );
  ...
  late final _$signInWithFacebookAsyncAction = AsyncAction(
    '_LoginStoreBase.signInWithFacebook',
    context: context,
  );

  @override
  Future<UserCredential> signInWithFacebook() {
    return _$signInWithFacebookAsyncAction.run(
